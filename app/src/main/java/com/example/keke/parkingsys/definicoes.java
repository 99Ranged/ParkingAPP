...
public class definicoes extends AppCompatActivity {
    ...
    private definicoes.UserRegisterTask mGetVei = null;
    TextView nomecliente;
    TextView dnascimentocliente;
    TextView emailcliente;
    String[] parque;
    String[] parquedesc;
    String[] tipoveiculo;
    int numvei;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dnascimentocliente= (TextView) findViewById(R.id.Txt_dnascimento);
        nomecliente= (TextView) findViewById(R.id.Txt_nome);
        emailcliente= (TextView) findViewById(R.id.Txt_email);
        ...
        Button mveiButton = (Button) findViewById(R.id.Btn_logout);

        mveiButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent govei = new Intent(getBaseContext(), ParkingLogin.class);
        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position)
                {
                    ...
                    case 7:
                        Intent govei7 = new Intent(getBaseContext(), infolegal.class);
    ...
    private boolean attemptgetvei() {
        ...
        mGetVei = new definicoes.UserRegisterTask(useremailvei);
    ...
    public class UserRegisterTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            Log.d("TAG","Register link is :" + AppConfig.URL_GETCLIENTE);
            String tag_string_req = "req_register";

            StringRequest strReq = new StringRequest(Request.Method.POST,
                    AppConfig.URL_GETCLIENTE, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        if (!error) {
                            ...
                            nomecliente.setText(jObj.getString("nome"));
                           dnascimentocliente.setText(jObj.getString("dnascimento"));
                           emailcliente.setText(mEmail);
